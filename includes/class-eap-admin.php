...
class EAP_Admin {
	...
	private function activate_newly_built_widgets() {
		...
		if ( empty( $done['scroll-elements-built'] ) ) {
			$states['scroll-elements'] = 1;
			update_option( self::WIDGETS_OPTION, $states, false );
			$done['scroll-elements-built'] = 1;
			update_option( 'eap_widget_migrations', $done, false );
		}

		if ( empty( $done['filterable-gallery-built'] ) ) {
			$states['filterable-gallery'] = 1;
			update_option( self::WIDGETS_OPTION, $states, false );
			$done['filterable-gallery-built'] = 1;
			update_option( 'eap_widget_migrations', $done, false );
		}

		if ( empty( $done['breadcrumbs-built'] ) ) {
			$states['breadcrumbs'] = 1;
			update_option( self::WIDGETS_OPTION, $states, false );
			$done['breadcrumbs-built'] = 1;
			update_option( 'eap_widget_migrations', $done, false );
		}

		if ( empty( $done['table-of-content-built'] ) ) {
			$states['table-of-content'] = 1;
			update_option( self::WIDGETS_OPTION, $states, false );
			$done['table-of-content-built'] = 1;
			update_option( 'eap_widget_migrations', $done, false );
		}

		if ( empty( $done['author-box-built'] ) ) {
			$states['author-box'] = 1;
			update_option( self::WIDGETS_OPTION, $states, false );
			$done['author-box-built'] = 1;
			update_option( 'eap_widget_migrations', $done, false );
		}

		if ( empty( $done['flip-box-built'] ) ) {
			$states['flip-box'] = 1;
			update_option( self::WIDGETS_OPTION, $states, false );
			$done['flip-box-built'] = 1;
			update_option( 'eap_widget_migrations', $done, false );
		}
		...
		if ( empty( $done['nested-slider-built'] ) ) {
			$states['nested-slider'] = 1;
			update_option( self::WIDGETS_OPTION, $states, false );
			$done['nested-slider-built'] = 1;
			update_option( 'eap_widget_migrations', $done, false );
		}
